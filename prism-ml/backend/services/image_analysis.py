...
class ImageAnalysisService:
    def __init__(self, similarity_threshold: float = 0.9) -> None:
        ...
        self._known_images: List[KnownImage] = [
            KnownImage(name="city_street", url="https://images.unsplash.com/photo-1449824913935-59a10b8d2000"),
            KnownImage(name="mountain_lake", url="https://images.unsplash.com/photo-1501785888041-af3ef285b470"),
            KnownImage(name="office_desk", url="https://images.unsplash.com/photo-1498050108023-c5249f4df085"),
        ]
    ...
    def analyze_image_url(self, image_url: str) -> Dict[str, float | bool]:
        ...
        scores = [self._cosine_similarity(target_embedding, self._known_image_embedding(k)) for k in self._known_images]
